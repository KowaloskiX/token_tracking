...
from minerva.core.services.llm_providers.openai.openai_client_config import get_shared_async_openai_client
...
class OpenAILLM:
    def __init__(
        ...
        if _shared_async_openai is None:
            _shared_async_openai = get_shared_async_openai_client()
