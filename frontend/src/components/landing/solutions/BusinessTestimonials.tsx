export default function BusinessTestimonials() {
    return (
      ...
      //               <div className="font-medium text-foreground">Judith Black</div>
      //               <div className="mt-1 text-body-text">CEO of Tuple</div>
      //             </div>
      //           </figcaption>
      //         </figure>
      //       </div>
      ...
      //             />
      //             <div className="text-base">
      //               <div className="font-medium text-foreground">Joseph Rodriguez</div>
      //               <div className="mt-1 text-body-text">CEO of Reform</div>
      //             </div>
      //           </figcaption>
      //         </figure>
      //       </div>
